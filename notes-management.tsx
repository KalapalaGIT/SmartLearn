...
import { Search, BookOpen, FolderPlus, Tag, Upload, MoreHorizontal, Star, Book, FilePlus, File, BarChart2, List, Award, Settings } from 'lucide-react';
...
const NotesManagement = () => {
  ...
  const getCollectionColor = (name) => {
    ...
    return collection ? collection.color : "#6B7280";
  };
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="w-16 bg-indigo-700 flex flex-col items-center py-8">
        ...
        <div className="flex flex-col items-center space-y-8">
          ...
          <button className="p-2 rounded-lg bg-indigo-600">
